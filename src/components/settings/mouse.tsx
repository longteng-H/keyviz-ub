...
export const MouseSettings = () => {
    ...
    return <div className="flex flex-col gap-y-4 p-6">
        ...
        <h2 className="text-sm text-muted-foreground font-medium">{t('mouse.cursorHighlight.title')}</h2>
        <Item variant="muted">
            <ItemContent>
                <ItemTitle>
                    <HugeiconsIcon icon={CursorMagicSelection03FreeIcons} size="1em" /> {t('mouse.showClicks.title')}
                </ItemTitle>
                <ItemDescription>
                    {t('mouse.showClicks.description')}
                </ItemDescription>
            </ItemContent>
            <ItemActions>
                <Switch
        ...
        <Item variant="muted">
            <ItemContent>
                <ItemTitle>
                    <HugeiconsIcon icon={Cursor01Icon} size="1em" /> {t('mouse.alwaysHighlight.title')}
                </ItemTitle>
                <ItemDescription>
                    {t('mouse.alwaysHighlight.description')}
                </ItemDescription>
            </ItemContent>
            <ItemActions>
                <Switch
        ...
        <h2 className="text-sm text-muted-foreground font-medium mt-2">{t('mouse.buttonIndicator.title')}</h2>
        <Item variant="muted">
            <ItemContent>
                <ItemTitle>
                    <HugeiconsIcon icon={MouseLeftClick05Icon} size="1em" /> {t('mouse.showIndicator.title')}
                </ItemTitle>
                <ItemDescription>
                    {t('mouse.showIndicator.description')}
                </ItemDescription>
            </ItemContent>
            <ItemActions>
                <Switch
        ...
        <Item variant="muted">
            <ItemContent>
                <ItemTitle>
                    <HugeiconsIcon icon={Cursor01Icon} size="1em" /> {t('mouse.keepIndicator.title')}
                </ItemTitle>
                <ItemDescription>
                    {t('mouse.keepIndicator.description')}
                </ItemDescription>
            </ItemContent>
            <ItemActions>
                <Switch
        ...
        <Item variant="muted">
            <ItemContent>
                <ItemTitle>
                    <HugeiconsIcon icon={ArrowExpand02Icon} size="1em" /> {t('mouse.offset.title')}
                </ItemTitle>
                <ItemDescription>
                    {t('mouse.offset.description')}
                </ItemDescription>
            </ItemContent>
            <ItemActions>
                <NumberScrubber
        ...
        <h2 className="text-sm text-muted-foreground font-medium mt-2">{t('mouse.event.title')}</h2>
        <Item variant="muted">
            <ItemContent>
                <ItemTitle>
                    <HugeiconsIcon icon={Drag03Icon} size="1em" /> {t('mouse.dragThreshold.title')}
                </ItemTitle>
                <ItemDescription>
                    {t('mouse.dragThreshold.description')}
                </ItemDescription>
            </ItemContent>
            <ItemActions>
                <NumberInput
