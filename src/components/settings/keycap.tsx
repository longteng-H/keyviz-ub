...
export const colorSchemes: KeycapTheme[] = [
    { nameKey: "Silver", name: "Silver", primary: "#f8f8f8", secondary: "#dcdcdc", text: "#000000" },
    { nameKey: "Stone", name: "Stone", primary: "#606060", secondary: "#4b4b4b", text: "#f8f8f8" },
    { nameKey: "Lime", name: "Lime", primary: "#606060", secondary: "#4b4b4b", text: "#D6ED17" },
    { nameKey: "Cyber", name: "Cyber", primary: "#00B1D2", secondary: "#008ea8", text: "#FDDB27" },
    { nameKey: "Turquoise", name: "Turquoise", primary: "#42EADD", secondary: "#2ec4b8", text: "#ffffff" },
    { nameKey: "Blue", name: "Blue", primary: "#2196f3", secondary: "#1976d2", text: "#ffffff" },
    { nameKey: "Yellow", name: "Yellow", primary: "#FDDB27", secondary: "#dfc019", text: "#000000" },
    { nameKey: "Green", name: "Green", primary: "#66bb6a", secondary: "#43a047", text: "#ffffff" },
    { nameKey: "Pink", name: "Pink", primary: "#f06292", secondary: "#d81b60", text: "#ffffff" },
    { nameKey: "Red", name: "Red", primary: "#ef5350", secondary: "#c62828", text: "#ffffff" },
    { nameKey: "Pansy", name: "Pansy", primary: "#673ab7", secondary: "#4527a0", text: "#ffc107" },
    { nameKey: "Eclipse", name: "Eclipse", primary: "#343148", secondary: "#252333", text: "#D7C49E" },
    { nameKey: "Bumblebee", name: "Bumblebee", primary: "#404040", secondary: "#2e2e2e", text: "#FDDB27" },
    { nameKey: "Charcoal", name: "Charcoal", primary: "#404040", secondary: "#2e2e2e", text: "#FFFFFF" },
];
...
export const KeycapSettings = () => {
    ...
    return <div className="flex flex-col p-6 gap-y-4">
        ...
        <h2 className="text-sm text-muted-foreground font-medium">{t('keycap.preset.title')}</h2>
        <Item variant="muted">
            <ItemActions className="w-full">
                <Select value={appearance.style} onValueChange={onStyleChange}>
                    ...
                    <SelectContent>
                        <SelectGroup>
                            <SelectItem value="minimal">{t('keycap.preset.styles.minimal')}</SelectItem>
                            <SelectItem value="laptop">{t('keycap.preset.styles.laptop')}</SelectItem>
                            <SelectItem value="lowprofile">{t('keycap.preset.styles.lowprofile')}</SelectItem>
                            <SelectItem value="pbt">{t('keycap.preset.styles.pbt')}</SelectItem>
                        </SelectGroup>
                    </SelectContent>
                </Select>
                <DropdownMenu>
                        ...
                        <DropdownMenuGroup>
                            {
                                colorSchemes.map((scheme) => (
                                    <DropdownMenuItem key={scheme.name} onClick={() => {
                                        ...
                                        >
                                            A</div>
                                        {t(`keycap.themes.${scheme.nameKey}`)}
                                    </DropdownMenuItem>
                                ))
                            }
                        </DropdownMenuGroup>
                ...
                <Button variant="outline" size="sm" className="ml-auto" onClick={importStyle}>
                    <HugeiconsIcon icon={Download01Icon} className="mr-2" /> {tCommon('actions.import')}
                </Button>
                <Button variant="outline" size="sm" onClick={exportStyle}>
                    <HugeiconsIcon icon={Upload01Icon} className="mr-2" /> {tCommon('actions.export')}
                </Button>
            </ItemActions>
        </Item>
        ...
        <Collapsible>
            <CollapsibleTrigger>
                <h2 className="text-sm text-muted-foreground font-medium">{t('keycap.sizePosition.title')}</h2>
            </CollapsibleTrigger>
            <CollapsibleContent className="flex flex-col gap-y-4 pt-4">
                <Item variant="muted">
                    <ItemContent>
                        <ItemTitle>{t('keycap.sizePosition.scale')}</ItemTitle>
                        <ItemDescription>{t('keycap.sizePosition.scaleDescription')}</ItemDescription>
                    </ItemContent>
                    <ItemActions>
                        <NumberInput
                ...
                <Item variant="muted">
                    <ItemContent>
                        <ItemTitle>{t('keycap.sizePosition.offsetX')}</ItemTitle>
                        <ItemDescription>{t('keycap.sizePosition.offsetDescription')}</ItemDescription>
                    </ItemContent>
                    <ItemActions>
                        <NumberInput
                            value={appearance.offsetX}
                            onChange={(offsetX) => setAppearance({ offsetX })}
                            minValue={-200}
                            maxValue={200}
                            step={1}
                            className="w-28 h-8"
                ...
                <Item variant="muted">
                    <ItemContent>
                        <ItemTitle>{t('keycap.sizePosition.offsetY')}</ItemTitle>
                        <ItemDescription>{t('keycap.sizePosition.offsetDescription')}</ItemDescription>
                    </ItemContent>
                    <ItemActions>
                        <NumberInput
                            value={appearance.offsetY}
                            onChange={(offsetY) => setAppearance({ offsetY })}
                            minValue={-200}
                            maxValue={200}
                            step={1}
                            className="w-28 h-8"
                ...
                <Button
                    variant="outline"
                    size="sm"
                    onClick={() => setAppearance({ scale: 1.0, offsetX: 0, offsetY: 0 })}
                >
                    {t('keycap.sizePosition.reset')}
                </Button>
            </CollapsibleContent>
        </Collapsible>
        ...
        <Collapsible defaultOpen={true}>
            <CollapsibleTrigger>
                <h2 className="text-sm text-muted-foreground font-medium">{t('keycap.text.title')}</h2>
            </CollapsibleTrigger>
            <CollapsibleContent className="flex flex-col gap-y-4 pt-4">
                <ItemGrid className="md:grid-cols-[240px_1fr]">
                    ...
                    <ItemGroup>
                        ...
                        <Item variant="muted" className="flex-2">
                            <ItemContent>
                                <ItemTitle>{t('keycap.text.variant.title')}</ItemTitle>
                            </ItemContent>
                            <ItemActions>
                                <Select value={text.variant} onValueChange={(value) => {
                                    ...
                                    <SelectTrigger className="w-28">
                                        <SelectValue placeholder={t('keycap.text.variant.placeholder')} />
                                    </SelectTrigger>
                                    <SelectContent>
                                        <SelectItem value="text">{t('keycap.text.variant.options.text')}</SelectItem>
                                        <SelectItem value="text-short">{t('keycap.text.variant.options.text-short')}</SelectItem>
                                        <SelectItem value="icon">{t('keycap.text.variant.options.icon')}</SelectItem>
                                    </SelectContent>
                                </Select>
                ...
                <ItemGrid>
                    ...
                    </Item>
                    {
                        ...
                        <Item variant="muted">
                            <ItemContent>
                                <ItemTitle>{t('keycap.text.modifierColor')}</ItemTitle>
                            </ItemContent>
                            <ItemActions>
        ...
        <Collapsible>
            <CollapsibleTrigger>
                <h2 className="text-sm text-muted-foreground font-medium">{t('keycap.layout.title')}</h2>
            </CollapsibleTrigger>
            <CollapsibleContent className="flex flex-col gap-y-4 pt-4">
                <ItemGrid>
                    <Item variant="muted">
                ...
                <Item variant="muted">
                    <ItemContent>
                        <ItemTitle>{t('keycap.layout.symbol.title')}</ItemTitle>
                        <ItemDescription>{t('keycap.layout.symbol.description')}</ItemDescription>
                    </ItemContent>
                    <ItemActions>
                        <Switch
                ...
                </Item>
                {
                    ...
                    <Item variant="muted">
                        <ItemContent>
                            <ItemTitle>{t('keycap.layout.pressCount.title')}</ItemTitle>
                            <ItemDescription>{t('keycap.layout.pressCount.description')}</ItemDescription>
                        </ItemContent>
                        <ItemActions>
                            <Switch
...

        {
            ...
            <Collapsible>
                <CollapsibleTrigger>
                    <h2 className="text-sm text-muted-foreground font-medium">{t('keycap.color.title')}</h2>
                </CollapsibleTrigger>
                <CollapsibleContent className="flex flex-col gap-y-4 pt-4">
                    <Item variant="muted">
                        <ItemContent>
                            <ItemTitle>{t('keycap.color.highlightModifier.title')}</ItemTitle>
                            <ItemDescription>{t('keycap.color.highlightModifier.description')}</ItemDescription>
                        </ItemContent>
                        <ItemActions>
                    ...
                    }
                    {
                        (appearance.style === "laptop") ?
                            ...
                            <>
                                {modifier.highlight && <h1>{t('keycap.color.normal')}</h1>}
                                <ItemGrid>
                                    <Item variant="muted">
                                        <ItemContent>
        ...
        <Collapsible>
            <CollapsibleTrigger>
                <h2 className="text-sm text-muted-foreground font-medium">{t('keycap.border.title')}</h2>
            </CollapsibleTrigger>
            <CollapsibleContent className="flex flex-col gap-y-4 pt-4">
                <ItemGrid>
                    <Item variant="muted">
                    ...
                    </Item>
                    {
                        modifier.highlight && <Item variant="muted">
                            <ItemContent>
                                <ItemTitle>{t('keycap.border.modifierColor')}</ItemTitle>
                            </ItemContent>
                            <ItemActions>
                                <ColorInput
        ...
        <Collapsible>
            <CollapsibleTrigger>
                <h2 className="text-sm text-muted-foreground font-medium">{t('keycap.background.title')}</h2>
            </CollapsibleTrigger>
            <CollapsibleContent className="flex flex-col gap-y-4 pt-4">
                <ItemGrid>
                    <Item variant="muted">
